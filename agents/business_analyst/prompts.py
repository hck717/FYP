...
14. SEGMENT SPECIFICITY (CRITICAL): For business model analysis, you MUST name concrete
    product/service/geography segments when they are present in context (e.g., iPhone,
    Services, Mac, iPad, Wearables, Greater China). Do NOT use generic phrasing like
    "product cycles" without naming which segment(s) drive the cycle.
""".strip()
